...
//  private ReportDto.Request request;
  ...
  void reportMember_success_reportablePeriod() {
    ...
    ReportDto.Request request = new Request(otherMember.getMemberId(),ReportType.OTHER,"분란을 조장해요");
  ...
  void reportMember_fail_NOT_FOUND_MEMBER() {
    ...
    // Given
    ReportDto.Request request = new Request(-1L ,ReportType.OTHER,"분란을 조장해요");
